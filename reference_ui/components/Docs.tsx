...
import { Check, ChevronLeft, Search, BookOpen, Sparkles, Zap, Cpu, LayoutGrid, FileText, Menu, X } from './ui/Icons';
...
3. Analysis (30 pts): Explains HOW the evidence supports the thesis.`}
                    ...
                    <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-6">
                        ...
                        <p className="text-zinc-600">
                            Providing a "Gold Standard" answer helps the AI calibrate. For math/science, provide the step-by-step calculation. For essays, provide an example of an 'A' grade paper or a list of key themes that must be mentioned.
                        </p>
                    </div>
                </div>
            </div>
      ...
      case 'models':
        return (
            ...
            <div className="grid gap-6">
             ...
             <div className="bg-zinc-900 text-zinc-300 p-6 rounded-xl">
                 <h3 className="text-white font-bold mb-2">Consensus Grading (Average)</h3>
                 <p className="text-sm leading-relaxed">
                     When multiple models are selected, GradeMind runs the assignment through each model independently and averages the scores. The feedback is synthesized to highlight points where the models agreed. This significantly reduces the chance of AI "hallucination" or bias.
                 </p>
             </div>
          </div>
        );
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-yellow-50 border border-yellow-100 p-4 rounded-lg mt-4 text-sm text-yellow-800">
                        <strong>Note:</strong> For scanned PDFs (images), the system will use OCR capabilities within the Gemini model, but text-based PDFs yield the highest accuracy.
                    </div>
                </div>
            </div>
          );
