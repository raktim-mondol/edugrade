...
import { Plus, Folder, Trash2, Check, ChevronRight, LogOut } from './ui/Icons';
...
const Workspaces: React.FC<WorkspacesProps> = ({ assignments, onCreateNew, onSelect, onDelete, onLogout }) => {
  return (
    <div className="min-h-screen w-full bg-zinc-50 flex flex-col relative isolate overflow-x-hidden">
      {/* Enforce solid background to prevent bleed-through artifacts */}
        ...
        <div className="max-w-6xl mx-auto w-full space-y-8 animate-in fade-in duration-500">
          <div className="flex items-center justify-between">
             <div>
               ...
               <p className="text-zinc-500 mt-1">Manage your assignments and grading sections.</p>
             </div>
             <button 
               onClick={onCreateNew}
