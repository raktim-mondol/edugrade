        ...
        <div className="prose prose-zinc max-w-none space-y-12">
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed">
              GradeMind ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our automated grading services. 
              <br/><br/>
          ...
          <section>
            ...
            <p className="text-zinc-600 leading-relaxed">
              ...
              <br/><br/>
              <strong>Data Retention:</strong> We retain student data only for as long as necessary to fulfill the purposes outlined in this policy. You may delete assignments and student data from your workspace at any time, which permanently removes it from our servers.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-4">5. Disclosure of Information</h2>
            <p className="text-zinc-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-4">6. Contact Us</h2>
            <p className="text-zinc-600 leading-relaxed">
